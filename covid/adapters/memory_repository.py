...
from covid.domain.model import Article, Tag, User, Comment, make_tag_association, make_comment, Movie, Genre, Actor, Review, Director, WatchList
...
def populate(data_path: str, repo: MemoryRepository):
    ...
    # Lead movies into the repository.
